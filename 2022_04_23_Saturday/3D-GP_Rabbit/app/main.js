/*@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
 * WEBGL 2.0    :   3D Gray-Pathnamathan Model 
 *
 * PROGRAMMER   :   ABOUZAR KABOUDIAN
 * DATE         :   Tue 12 Jun 2018 06:23:07 PM EDT
 ...
 */
    ...
    gui.dispFldr.add(env, 'structural_alpha').min(0).max(1.).step(0.001).onChange(function(){
            env.vrc.structural_alpha = env.structural_alpha ;
            } ) ;

    gui.dispFldr.add(env, 'noSteps').name('Number of Steps').
        min(30).max(800).step(1).onChange(function(){
 ...
 */
    env.compUniforms    = function( _inTrgt){
        ...
        this.gNa        = { type : 'f',     value : env.gNa     } ;
        this.Em         = { type : 'f',     value : env.Em      } ;
        this.km         = { type : 'f',     value : env.km      } ;
        this.tm         = { type : 'f',     value : env.tm      } ;
        this.Eh         = { type : 'f',     value : env.Eh      } ;
        this.kh         = { type : 'f',     value : env.kh      } ;
        this.t0h        = { type : 'f',     value : env.t0h     } ;
        this.dh         = { type : 'f',     value : env.dh      } ;
        this.gK         = { type : 'f',     value : env.gK      } ;
        this.b          = { type : 'f',     value : env.b       } ;
        this.ENa        = { type : 'f',     value : env.ENa     } ;
        this.EK         = { type : 'f',     value : env.EK      } ;
 ...
 */
    ...
    env.vrc.addMessage(
        '3D Gray-Pathnamathan Rabbit Ventricular Model',
        0.5,
        0.05,
        {
 ...
 */
    env.plot = new Abubu.SignalPlot( { 
        ...
        yticks : { mode : 'auto', unit : 'mv' , precision:1} ,
        canvas : canvas_2 ,
        } ) ;
 ...
 */
    ...
    env.shiftClick = new Abubu.ShiftClickListener(
     ...
     env.commandClick = new Abubu.CommandClickListener(
            canvas_1,
            function(e){
                env.vrc.updateClickPosition(e.position) ;
                env.click.render() ;
